        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-2">
                    ...
                    <a href="course"><i class="fa-regular fa-clock"></i>Quản Lý Môn Học</a>
                    <a class="active" href="class"><i class="fa-solid fa-landmark"></i>Quản Lý Lớp Học</a>
                            ...
                            <div class="row">
                              <nav aria-label="breadcrumb">
                                  <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="class">Quản Lý Lớp Học</a></li>
                                    <li class="breadcrumb-item " aria-current="page">IT0501 </li>
                                  </ol>
                              </nav>
                                <h3 style="font-weight: 600;">Class / Lớp Học</h3>
                                <div class="col-6">
                                    <div class="table-attendance">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                              <tr>
                                                <td>1</td>
                                                <td scope="row">BH00004</td>
                                                <td>hungld@fpt.edu.vn</td>                                             
                                                <td>Le Duc Hung</td>
                                                <td>
                                                    <a href="#"><i class="fa-sharp fa-solid fa-minus"></i></a>
                                                </td>
                                              </tr>
                                              <tr>
                                                <td>2</td>
                                                <td scope="row">BH00005</td>
                                                <td>hungld@fpt.edu.vn</td>                                             
                                                <td>Le Duc Hung</td>
                                                <td>
                                                  <a href="#"><i class="fa-sharp fa-solid fa-minus"></i></a>
                                ...
                                <div class="col-6">
                                    <form action="#">
                                        <h5>Add Student / Thêm Sinh Viên</h5>
                                        <b>Các Sinh Viên Chưa Có Lớp / Students Without Class</b>
                                        <table class="table table-striped">
                                            <thead>
                                              <tr>
                                                <th scope="col">Student ID</th>
                                            ...
                                            <tbody>
                                              <tr>
                                                <td>BH0001</td>                                             
                                                <td>Le Duc Hung</td>
                                                <td>Mới Nhập Học</td>
                                                <td>Computing</td>
                                                <td><a href="#"><i class="fa-solid fa-plus"></i>Add Class</a></td>
                                              </tr>
                                              <tr>
                                                <td>BH0002</td>                                             
                                                <td>Le Van Hung</td>
