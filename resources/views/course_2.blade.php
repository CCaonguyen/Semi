        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-2">
                    ...
                    <a href="homepage.html"><i class="fa-solid fa-house"></i>Trang Chủ</a>
                    <a href="attendance.html"><i class="fa-solid fa-user-check"></i>Quản Lý Điểm Danh</a>
                    <a class="active" href="course.html"><i class="fa-regular fa-clock"></i>Quản Lý Môn Học</a>
                    <a href="class.html"><i class="fa-solid fa-landmark"></i>Quản Lý Lớp Học</a>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                      <li class="breadcrumb-item"><a href="homepage.html">Trang Chủ</a></li>
                                      <li class="breadcrumb-item"><a href="manage-attendance.html">Quản Lý Môn Học</a></li>
                                      <li class="breadcrumb-item " aria-current="page">Programming</li>
                                    </ol>
                                </nav>
                                <h3 style="font-weight: 600;">PROGRAMMING </h3>
                                <p>Start Date: 20/02/2023</p>
                                <div class="col-12">
                                    <div class="table-attendance">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>1</td>
                                                    <td><input type="date" class="form-control" value="2023-02-20"></td>
                                                    <td>1</td>
                                                    <td>Nguyễn Văn A</td>
                                                    <td class="warning">Coming</td>
                                                    <td><input class="form-control" type="text" name="note" id="note"></td>
                                                </tr>
                                                <tr>
                                                    <td>2</td>
                                                    <td><input type="date" class="form-control" value="2023-02-22"></td>
                                                    <td>1</td>
                                                    <td>Nguyễn Văn A</td>
                                                    <td class="warning">Coming</td>
                                                    <td><input class="form-control" type="text" name="note" id="note"></td>
                                                ...
                                                <tr>
                                                    <td>3</td>
                                                    <td><input type="date" class="form-control" value="2023-02-24"></td>
                                                    <td>1</td>
                                                    <td>Nguyễn Văn A</td>
                                                    <td class="warning">Coming</td>
                                                    <td><input class="form-control" type="text" name="note" id="note"></td>
                                                ...
                                                <tr>
                                                    <td>4</td>
                                                    <td><input type="date" class="form-control" value="2023-02-26"></td>
                                                    <td>1</td>
                                                    <td>Nguyễn Văn A</td>
                                                    <td class="warning">Coming</td>
                                                    <td><input class="form-control" type="text" name="note" id="note"></td>
                                                ...
                                                <tr>
                                                    <td>5</td>
                                                    <td><input type="date" class="form-control" value="2023-02-28"></td>
                                                    <td>1</td>
                                                    <td>Nguyễn Văn A</td>
                                                    <td class="warning">Coming</td>
                                                    <td><input class="form-control" type="text" name="note" id="note"></td>
